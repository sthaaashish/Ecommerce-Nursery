...
const Privacy_Policy = () => {
  return (
    <div>
      <p className="p-6">
        Privacy Policy Last updated: 2023 ,Pipal Nursery ("us", "we", or
        "our") operates [your website URL] (the "Site"). This page informs you
        of our policies regarding the collection, use, and disclosure of
        Personal Information we receive from users of the Site. Information
        Collection and Use While using our Site, we may ask you to provide us
        ...
        address, and phone number ("Personal Information"). Log Data Like many
        ...
        Cookies Cookies are files with small amounts of data, which may include
        an anonymous unique identifier. Cookies are sent to your browser from a
        web site and stored on your computer's hard drive. Security The security
        of your Personal Information is important to us, but remember that no
        ...
        effective as of [Date] and will remain in effect except with respect to
        ...
        abide and be bound by the modified Privacy Policy. If we make any
        ...
        Privacy Policy, please contact us at [your contact email address].
      </p>
    </div>
  );
};
